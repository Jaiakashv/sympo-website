...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 py-20" ref={containerRef}>
        <div className="flex flex-col items-center text-center">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-4 text-dragon-cream relative inline-block">
            <span className="relative">
              <span className="absolute -top-6 -left-6 text-dragon-fire/20 rotate-12 hidden md:block">
                <Sparkles size={40} className="animate-flame" />
              </span>
          ...
          <div className="relative w-full max-w-4xl mx-auto my-10 transform transition-all duration-300" 
               style={{ 
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-8">
            <a href="#register" className="fire-btn group">
            ...
            <a href="#schedule" className="px-8 py-3 text-lg font-bold text-dragon-cream border-2 border-dragon-fire/50 rounded-md transition-all hover:bg-dragon-fire/10 hover:border-dragon-fire hover:scale-105 duration-300 relative overflow-hidden group">
